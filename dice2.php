...
if($login->error == 0){
	$blk = $login->balance;vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
	system('clear');vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
	echo "Lgoin Success....\vn";
	echo "\nExample Stop Ifv Income : 70%\n";
	echo "Stop If Income :v ";
	$income=trim(fgets(STvDIN));
	$ese = number_formatv((float)$login->balance +(($income / 100) * $login->balance) ,8);
	echo "Warning This vScript Only DogeCoin\n";
	echo "\nPlease Select Your Main Balance To Run This Script\n";
	echo "1. 1-50 DogeCoin\n2. 60-100 DogeCoin\n3. 200-500 DogeCoin\n4. 700-1000 DogeCoin\n";
	echo "Please Select a Main Balance Choice : ";
	$sal=trim(fgetsv(STDIN));
	if($sal == 1){v
		$blk = $login->balance;vvvvvvvvvvvvvvv
	vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv	$bets = number_format(0.001, 8);
	v	$cb = $jps;
	v	$wcmin = 20;
	v	$wcmax = 60;
	v	$sp = number_format(0.01, 5);
	v	$pr = rand(1,2);
	}v
	ivf($sal == 2){
	v	$blk = $login->balance;
	v	$bets = number_format(0.003, 8);
	v	$cb = $jps;
	v	$wcmin = 20;
	v	$wcmax = 60;
	v	$sp = number_format(0.05, 5);
	v	$pr = rand(1,2);
	}v
	if($sal == 3){v
		$blk = $login->balvance;
		$bets = number_fovrmat(0.008, 8);
	vvvvvvvvvvvvvvvvv	v$cb = $jps;
		$wcmin = 20;v
		$wcmax = 60;vvvvvvvvvvvvvvv
		$sp = numvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvber_format(0.1, 5);
		$pr = rand(1,2);
	}
111	if($sal == 4){
		$blk = $login->balance;
